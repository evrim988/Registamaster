...
public class Repository : IRepository
{
  ...
  public async Task<ICollection<T>> UpdateRange<T>(ICollection<T> _objectList) where T : BaseEntitiy
  {
    try
    {
  ...
  public async Task<ICollection<T>> DeleteRange<T>(ICollection<T> _objectList) where T : BaseEntitiy
  {
    try
    {
      foreach (var item in _objectList)
