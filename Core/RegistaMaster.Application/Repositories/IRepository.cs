...
public interface IRepository
{
  ...
  Task<ICollection<T>> UpdateRange<T>(ICollection<T> _objectList) where T : BaseEntitiy;
  Task<ICollection<T>> DeleteRange<T>(ICollection<T> _objectList) where T : BaseEntitiy;
